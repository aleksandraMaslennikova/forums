...
def divideDictInTrainingValidationTest(max_review_length, word_embedding_dict):
    ...
    with open('data/dict/' + str(word_embedding_dict) + '/' + str(max_review_length) + '/final_corpus_' + str(word_embedding_dict) + '_max_length_' + str(max_review_length) + '.pickle', 'rb') as handle:
    ...
    with open('data/dict/' + str(word_embedding_dict) + '/' + str(max_review_length) + '/final_corpus_training_' + str(word_embedding_dict) + '_max_length_' + str(max_review_length) + '.pickle', 'wb') as handle:
    ...
    for message_dict in corpus:
        user_id = message_dict["user_id"]
        if user_id in validation_user_id:
            validation.append(message_dict)
    with open('data/dict/' + str(word_embedding_dict) + '/' + str(max_review_length) + '/final_corpus_validation_' + str(word_embedding_dict) + '_max_length_' + str(max_review_length) + '.pickle', 'wb') as handle:
    ...
    with open('data/dict/' + str(word_embedding_dict) + '/' + str(max_review_length) + '/final_corpus_test_' + str(word_embedding_dict) + '_max_length_' + str(max_review_length) + '.pickle', 'wb') as handle:
