...
def runTraining(X_train, y_train, X_validation, y_validation, embedding_matrix,
    ...
    # separated layers
    y1 = Bidirectional(LSTM(num_neurons, dropout=0.2, recurrent_dropout=0.2))(main_branch)
    y1 = Dense(1, activation='softmax', name='age')(y1)

    y2 = Bidirectional(LSTM(num_neurons, dropout=0.2, recurrent_dropout=0.2))(main_branch)
